...
THROUGH = {"France","Morocco","Norway","England","Spain","Belgium","Argentina","Switzerland"}           # e.g. {"Germany","Mexico"}
# ------------------------------------------------------------
...
GOALS = {"Lionel Messi":8,"Cristiano Ronaldo":3,"Folarin Balogun":3,"Kai Havertz":3,"Kylian Mbappe":7,"Erling Haaland":7,"Harry Kane":6,"Jamal Musiala":1,"Alexander Isak":1,"Viktor Gyokeres":1,"Vinicius Junior":4,"Breel Embolo":2,"John McGinn":1,"Jude Bellingham":4,"Marcus Rashford":1,"Luis Diaz":1,"Jonathan David":3,"Matheus Cunha":3,"Cody Gakpo":3,"Mikel Oyarzabal":4,"Lamine Yamal":1,"Mohamed Salah":1,"Ousmane Dembele":4,"Desire Doue":1,"Kevin De Bruyne":1,"Romelu Lukaku":3,"Lautaro Martinez":1,"Neymar":1,"Raul Jimenez":1}
